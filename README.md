...
&nbsp;&nbsp;- Create a name, username, and password (remember the username and password) <br>
&nbsp;&nbsp;- This will create a new Virtual Network (Vnet) <br>
...
&nbsp; &nbsp;- Create the directory in the C: Drive with the name "**PHP**". 
...
&nbsp; &nbsp;- Properties -> Security -> Advanced -> Disable inheritance -> Remove All <br>
&nbsp; &nbsp;- New Permissions -> Select a Principal -> Everyone -> All
